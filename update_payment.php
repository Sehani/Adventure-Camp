...
$to_email = $email;
$subject = 'Payment Details Of Olympia Adventure';
...
<table style="font-family:"Cabin",sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="color: #000000; line-height: 170%; text-align: center; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 170%;">Payment ID: '.$payID.'</p>
<p style="font-size: 14px; line-height: 170%;">First Name: '.$firstName.'</p>
<p style="font-size: 14px; line-height: 170%;">Last Name: '.$lastName.'</p>
<p style="font-size: 14px; line-height: 170%;">Mobile: '.$mobile.'</p>
<p style="font-size: 14px; line-height: 170%;">Aravial Date : '.$checkInDate.'</p>
<p style="font-size: 14px; line-height: 170%;">Depature Date: '.$checkOutDate.'</p>
  </div>
...
';
$from = 'thisaridilshani@email.com'; 
...
$sql = "UPDATE booking SET paid_status='paid', due_amount = '$amount'  WHERE booking_id='$bookID'";

if (mysqli_query($conn, $sql)) {
$sql_update = "UPDATE payments SET total='$amount', status='paid', payment_date='$date' WHERE booking_id='$bookID'";
